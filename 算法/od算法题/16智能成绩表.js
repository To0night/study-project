...
async function processInput() {
	...
	students.sort((s1, s2) => {
		let score1, score2;
		if (!s1.getScore(rankSubject) && !s2.getScore(rankSubject)) {
			score1 = s1.totalScore;
			score2 = s2.totalScore;
		} else {
			score1 = s1.getScore(rankSubject);
			score2 = s2.getScore(rankSubject);
		}
		if (score1 !== score2) {

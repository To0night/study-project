...
// 用于存储所有分销商信息的全局变量
let n; // 分销关系的数量
const income = {}; // 记录每个分销商的收入 { id1: come1, id2: come2}
const ids = new Set(); // 记录所有的分销商 ID [id1, id2]
const childToParent = {}; // 记录子分销商到父分销商的映射关系  {children1:parent, children2:parent}
const parentToChildren = {}; // 记录父分销商到其所有子分销商的映射关系  { parent1:[11,22,33]}
